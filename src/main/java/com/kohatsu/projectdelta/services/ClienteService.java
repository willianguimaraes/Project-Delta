...
public class ClienteService {
	...
	public Cliente fromDTO(ClienteNewDTO objDto) {
		...
		if(objDto.getId() == null) {
			...
			Cliente cliente = new Cliente(null, objDto.getEmail(), objDto.getNome(), objDto.getSexo(), objDto.getCpf(), endereco, telefone);
			...
			Cliente cliente = new Cliente(objDto.getId(),objDto.getEmail(), objDto.getNome(), objDto.getSexo(), objDto.getCpf(), endereco, telefone);
