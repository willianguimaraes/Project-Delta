...
public class ProfissionalResource {
	...
	@GetMapping(value = "/entrar/{idProfissional}/{idCliente}")
    public ModelAndView index(@PathVariable("idProfissional") Integer idProf, @PathVariable("idCliente") Integer idCli) {
		
		pro = service.find(idProf);
		cli = clienteService.find(idCli);
		ModelAndView mv = new ModelAndView("pilates/index");
		
		mv.addObject("profissional", pro);
